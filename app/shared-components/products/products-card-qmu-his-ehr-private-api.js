...
const styles = {
    ...
    contentWrapper: {
        ...
        backgroundColor: '#4d5e61', // for his
 ...
 */
@Radium
class ProductsCardQmeupEhrPrivateAPI extends React.Component {
    constructor(props) {
        super(props);
    ...
    onMenuItemOpts() {
        const { product, productClientCredential, openQMUtoEHRPrivateApiClientSecretEdit, viewMode } = this.props;
        return [
            viewMode ? null : 
            {
                label: 'Change Client Key',
                action: openQMUtoEHRPrivateApiClientSecretEdit.bind(this, product, productClientCredential),
    ...
    onMenuDeleteOpts() {
        const { openQMUtoEHRPrivateApiDelete, product, productClientCredential, viewMode } = this.props;
        return [
            viewMode ? null : 
            {
                label: 'Remove App',
                action: openQMUtoEHRPrivateApiDelete.bind(this, product, productClientCredential),
...
// *** props
ProductsCardQmeupEhrPrivateAPI.propTypes = {
    product: PropTypes.object.isRequired,
};

export default ProductsCardQmeupEhrPrivateAPI;