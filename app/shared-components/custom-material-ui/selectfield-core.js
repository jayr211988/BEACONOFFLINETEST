...
class SelectFieldCore extends Component {
  static propTypes = {
    /**
  ...
  handleDropDownChange(event, key, value) {
    const {onChange} = this.props;

    if (onChange) {
      onChange(event, key, value);
      console.log('custom on change');
      console.log(this.refs.selecfieldcoreTextField); 
    }
  }
...
export default SelectFieldCore;