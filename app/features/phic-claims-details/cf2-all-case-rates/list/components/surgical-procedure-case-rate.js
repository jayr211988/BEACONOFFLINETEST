...
@Radium
class SurgicalProcedureCaseRate extends React.Component {

    constructor(props) {
        super(props);
    }

    displayLateralityType() {
        const { caseRate } = this.props;

        switch (caseRate.lateralityType) {
        case 0:
            return 'N/A';
        case 1:
            return 'LEFT';
    ...
    render() {
        const { caseRate, deletePHICAllCaseRate, summaryMode, newSelectedCf2 } = this.props;
        ...
        return (
            ...
            <StyleRoot style={styles.container}>
                ...
                <div style={styles.body}>
                    ...
                    <div style={styles.body.item}>
                        <label style={styles.body.item.label}>PROCEDURE</label>
                        {caseRate.surgicalProcedure}
                    </div>
                    <div style={styles.body.item}>
                        <label style={styles.body.item.label}>RVSCODE</label>
                        {caseRate.rvsCode}
                    </div>
                    <div style={styles.body.item}>
                    ...
                    <div style={styles.body.item}>
                        <label style={styles.body.item.label}>LATERALITY TYPE</label>
                        {this.displayLateralityType()}
                    </div>
                </div>
            </StyleRoot>
        );
...
export default SurgicalProcedureCaseRate;
