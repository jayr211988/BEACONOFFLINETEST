...
class ClientsNew extends React.Component {
    ...
    render() {
        const { newClientRequestPending, handleSubmit } = this.props;

        return (
            <StyleRoot style={animation.fadeIn}>
                <Helmet title = "Clients - New Client" />
                <form onSubmit={handleSubmit}>
                    <SubHeaderWithAction title={'New Client'} onCancel={this.onCancel.bind(this)} isBusy={newClientRequestPending} />
                        ...
                        <div style={style.clientInfoContainer}>
                            ...
                            <div style={style.displayFlex}>
                                <Field name="contactFirstname"
                                    ...
                                    validate={required}
                                    disabled={newClientRequestPending} />
